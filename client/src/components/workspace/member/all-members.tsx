...
const AllMembers = () => {
    ...
    const handleRemoval = () => {
        ...
        removeMember({ memberId: context._id, workspaceId });
    };
                        ...
                        {canRemoveMember && (
                            <>
                                ...
                                <ConfirmDialog
                                    ...
                                    title={`Remove ${
                                        context?.role.name.toLowerCase() ||
                                        "this item"
                                    }`}
                                    description={`Are you sure you want to remove ${
                                        context?.userId.name || "this item"
                                    } from workspace? This action cannot be undone.`}
                                    confirmText="Remove"
                                    cancelText="Cancel"
                                />
                            </>
